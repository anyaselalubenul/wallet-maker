## Crypto Web Wallet Application & Maker
### Features
...
1. Clone the repository:
    ```bash
    https://github.com/anyaselalubenul/wallet-maker.git
...
This app is build for Test Deployment on [Arlink](https://wallet-maker.arweave.net/).
